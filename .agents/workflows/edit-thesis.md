...
> 📌 **本项目论文路径**：`graduate_thesis/223020436_赖科成_初稿1.docx`（以实际文件名为准）
> 读论文统一用 **read-write-docx** skill（直接读 .docx），不要转 PDF 再读。
...
// turbo
```bash
copy "graduate_thesis\223020436_赖科成_初稿1.docx" "graduate_thesis\223020436_赖科成_初稿1_backup.docx"
```
...
// turbo
```bash
python .agents/skills/read-write-docx/scripts/edit_docx.py read "graduate_thesis/223020436_赖科成_初稿1.docx"
```
