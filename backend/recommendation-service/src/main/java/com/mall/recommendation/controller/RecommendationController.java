...
public class RecommendationController {
    ...
    /**
     * 获取用户个性化推荐商品 ID 列表（Wide & Deep 降序排列）
     */
    ...
    /**
     * 获取推荐结果（含 Wide & Deep 分数，用于前端展示排序依据）
     */
    ...
    public ResponseEntity<Map<String, Object>> serviceStatus() {
        ...
        return ResponseEntity.ok(Map.of(
                ...
                "mode", healthy ? "wide_deep" : "cold_start_fallback",
                "description", healthy
                        ? "Wide & Deep 模型推理服务正常运行"
